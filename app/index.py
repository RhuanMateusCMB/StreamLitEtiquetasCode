...
def extrair_itens_pedido(conteudo_pdf, pacote_dict):
    ...
    padrao_completo = r'(\d+)\s+(.*?)\s+(\d+,?\d*)\s*(UN|UND|KG|kg|Kg|G|g|Un|Und|un|und)\s+R\$\s*\d+,\d+\s+-----\s+R\$\s*\d+,\d+'
...
# Interface
url = "https://docs.google.com/spreadsheets/d/10xH-WrGzH3efBqlrrUvX4kHotmL-sX19RN3_dn5YqyA/edit?gid=990865530#gid=99086553"
